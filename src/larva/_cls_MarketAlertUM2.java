...
if (0==1){}
		...
		_state_id_Alerts = 63;//moving to state invalidAlert
		_goto_Alerts(_info);
		}
		...
		_state_id_Alerts = 64;//moving to state loggedIn
		_goto_Alerts(_info);
		}
}
}
...
switch(_state_id){
case 63: if (_mode == 0) return "invalidAlert"; else return "!!!SYSTEM REACHED BAD STATE!!! invalidAlert "+new _BadStateExceptionMarketAlertUM().toString()+" ";
case 64: if (_mode == 0) return "loggedIn"; else return "loggedIn";
